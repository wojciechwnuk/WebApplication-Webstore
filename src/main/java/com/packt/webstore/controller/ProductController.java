...
public class ProductController {
    ...
    @RequestMapping("/brand/{manufacturer}")
    public String filterProducts(Model model, @PathVariable("manufacturer") String productManufacturer) {
    ...
    public void initialiseBinder(WebDataBinder binder) {
        ...
        binder.setAllowedFields("productId", "name", "unitPrice","condition", "description","manufacturer", "category", "unitsInStock", "productImage");
    }
